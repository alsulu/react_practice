            ...
            {edit
                ? <React.Fragment>
                    ...
                    <td className={classnames(styles.buttons, styles.edit)}>
                        ...
                        <button className={styles.btnCancel} onClick={handleClick}>Отменить</button>
                    </td>
                </React.Fragment>
                : <React.Fragment>
                    ...
                    <td className={styles.buttons}>
                        <button className={styles.btnEdit} onClick={handleClick}><img src="https://cdn-icons-png.flaticon.com/512/51/51639.png" alt="редактировать" /></button>
